...
public class BookController {
    ...
    public List<Book> findForm(@RequestBody BookQuery example) {
        ...
        if (example.getReleaseDate() != null) {
            books.addAll(repository.findByReleaseDate(example.getReleaseDate()));
        }
        if (example.getAuthor() != null) {
            books.retainAll(repository.findByAuthor(example.getAuthor()));
        }
        ...
        books.retainAll(repository.findByContentContains(example.getContent(), pageable));
